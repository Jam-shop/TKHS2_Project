...
function addPieChartMarker(districtName, data, layer) {
    ...
    const chartData = {
        ...
        datasets: [{
            data: [
                data.Hindus * 100 / data.Total_Population,
                data.Muslims * 100 / data.Total_Population,
                (data.Christians + data.Sikhs + data.Buddhists + data.Jains + data.Others) * 100 / data.Total_Population
            ],
